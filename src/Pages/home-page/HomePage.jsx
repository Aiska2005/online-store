...
const HomePage = () => {
	...
	const handleViewAll = () => navigate("/product-all");
						...
						<div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
							<div className="flex items-center space-x-4">
								<button data-modal-toggle="filterModal" data-modal-target="filterModal" type="button"
									...
									<svg className="-ms-0.5 me-2 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
									     height="24" fill="none" viewBox="0 0 24 24">
										<path stroke="currentColor" stroke-linecap="round" stroke-width="2"
										      d="M18.796 4H5.204a1 1 0 0 0-.753 1.659l5.302 6.058a1 1 0 0 1 .247.659v4.874a.5.5 0 0 0 .2.4l3 2.25a.5.5 0 0 0 .8-.4v-7.124a1 1 0 0 1 .247-.659l5.302-6.059c.566-.646.106-1.658-.753-1.658Z"/>
									</svg>
									Filters
									<svg className="-me-0.5 ms-2 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
									     height="24" fill="none" viewBox="0 0 24 24">
						...
						<div className="relative h-full w-full max-w-xl md:h-auto">
							...
							<div className="relative rounded-lg bg-white shadow ">
									...
									<div className="mb-4 border-b border-gray-200 dark:border-gray-700">
										<ul className="-mb-px flex flex-wrap text-center text-sm font-medium" id="myTab"
											...
											<li className="mr-1" role="presentation">
												<button className="inline-block pb-2 pr-1" id="brand-tab" data-tabs-target="#brand"
												        type="button"
											...
											<div className="grid grid-cols-2 gap-3">
												<div>
													<label htmlFor="min-price"
													       className="block text-sm font-medium text-gray-900 dark:text-white"> Min Price </label>
												...
												<div>
													<label htmlFor="max-price"
													       className="block text-sm font-medium text-gray-900 dark:text-white"> Max Price </label>
											...
											<div className="space-y-3">
												<div>
													<label htmlFor="min-delivery-time"
													       className="block text-sm font-medium text-gray-900 dark:text-white"> Min Delivery Time
														(Days) </label>
												...
												<div className="space-y-2">
													<div className="flex items-center">
														...
														<label htmlFor="five-stars" className="ml-2 flex items-center">
															<svg aria-hidden="true" className="h-5 w-5 text-yellow-400" fill="currentColor"
													...
													<div className="flex items-center">
														...
														<label htmlFor="four-stars" className="ml-2 flex items-center">
															...
															<svg aria-hidden="true" className="h-5 w-5 text-gray-300 dark:text-gray-500"
												...
												<div className="space-y-2">
													<div className="flex items-center">
														...
														<label htmlFor="under-1-kg"
														       className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Under 1
															kg </label>
													</div>
													...
													<div className="flex items-center">
														...
														<label htmlFor="over-3-kg"
														       className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Over 3
															kg </label>
													</div>
												</div>
											</div>
								...
								<div className="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
									...
									<button type="reset"
									        className="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200  ">Reset
									</button>
								</div>
							</div>
						</div>
...
const ProductCard = ({image, name, price}) => {
	...
	return (
		<div className="rounded-lg border border-gray-200 p-2 shadow-sm">
			<div className="h-96 w-full flex items-center justify-center overflow-hidden rounded-lg bg-gray-100">
				<img
			...
			<div className="pt-2">
              ...
              <span className="sr-only">
                {isFavorite ? "Remove from favorites" : "Add to favorites"}
							...
							>
								<path
									...
									d={
										isFavorite
											? "M12 6c5.5-5 11.5 2 7 7l-7 7-7-7C.5 8 6.5 1 12 6Z"
											: "M12 6C6.5 1 1 8 5.8 13l6.2 7 6.2-7C23 8 17.5 1 12 6Z"
									}
								/>
							</svg>
						</button>
				...
				<div className={"flex flex-col  justify-between"}>
					<div>
						<p className="text-lg font-semibold leading-tight mb-2 line-clamp-2">{name}</p>
					</div>
					<div>
						<ul className="mt-2 flex items-center gap-4">
							...
							<li className="flex items-center gap-2">
								...
								<p className="text-sm font-medium">Лучшая цена</p>
							</li>
						</ul>
						<div className="mt-4 flex items-center justify-between gap-4">
							...
							<button
								type="button"
								className="inline-flex items-center rounded-lg border bg-primary-700 px-5 py-2.5 text-sm font-medium text-black hover:bg-primary-800 focus:outline-none"
							>
								<svg
